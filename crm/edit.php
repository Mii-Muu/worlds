            ...
            <div class="input-group">
                <form method="post">
                    <div class="row g-3">
                        ...
                        <div class="col-3">
                            <input type="text" name="assign" class="border rounded-5 form-control form-control-md bg-light px-4" placeholder="Assign To" value="<?php echo $row['assign']; ?>" required>
                        </div>
                        <div class="col-3">
